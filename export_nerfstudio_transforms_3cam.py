...
def find_default_image_dir(root: Path) -> Path:
    candidates = [
        ...
        root / "object_images",
        root / "images",
        root / "Calibration" / "object_images",
        root,
    ]
...
def main():
    ...
    parser.add_argument("--calib-dir", type=str, default=None, help="Calibration folder")
    parser.add_argument("--image-dir", type=str, default=None, help="Folder containing object images")
